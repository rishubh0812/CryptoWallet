...
import { BalanceInfo, IconTextButton, Chart, TabIcon } from '../components';
                    ...
                    ListHeaderComponent={
                        <View style={{marginBottom: SIZES.radius}}>
                            <Text style={{color: COLORS.white, ...FONTS.h3, 
                                fontSize: 18}}>Top Cryptocurrency</Text>
                        </View>
                    }
                    renderItem={({item}) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <View>
                                    ...
                                    ...FONTS.h4}}>$ {item.current_price}</Text>
...
function mapDispatchToProps(dispatch) {
    return {
        ...
        getCoinMarket: (currency, coinList, orderBy, sparkline, priceChangePerc,
            perpage, page) => {
                return dispatch(getCoinMarket(currency, coinList, orderBy, sparkline, priceChangePerc,
                    perpage, page))
            }
    }
}
