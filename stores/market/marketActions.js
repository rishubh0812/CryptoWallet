...
export function getHoldings(holdings =[], currency = "usd", orderBy
 ...
 perPage = 10, page =1) {
    return dispatch => {
        ...
        let apiUrl = "https://api.coingecko.com/api/v3/coins/markets?vs_currency=usd&ids=bitcoin%2Cdogecoin%2Cethereum&order=market_cap_desc&per_page=100&page=1&sparkline=true&price_change_percentage=7d"
        ...
        return axios({
            ...
            if(response.status == 200) {
                ...
                let myHoldings = response.data.map((item) => {
                    ...
                    let price7d = item.current_price / (1 + 
